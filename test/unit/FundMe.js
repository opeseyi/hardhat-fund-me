...
const { developmentChain } = require('../../helper-harrdhat-config');
...
!developmentChain.includes(network.name)
  ...
  : describe('FundMe', function () {
      ...
      describe('withdraw', function () {
        ...
        it('allows us to withdraw with miultiple s_funder', async function () {
          const accounts = await ethers.getSigners();
          for (let i = 1; i < 6; i++) {
        ...
        it('Only allows the owner to withdraw', async function () {
          ...
          await expect(attackerConnectedContract.withraw()).to.be.revertedWith(
            'FundMe__NotOwner'
          );
        });
        ////////////////////////////////////////////////////////////////////////////////////
